...
[
    ...
    [FP_SETTINGS,"Ragdolling"], // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
...
[
    QGVAR(ragdoll_ai), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
