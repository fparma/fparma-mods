...

{
...

  {
    ...
    {
      _type = _x;
      _amount = _itemCargo#1#_forEachIndex;
      _veh addItemCargoGlobal [_type, _amount];
    } foreach _itemCargo#0;

    {
      _type = _x;
      _amount = _magazineCargo#1#_forEachIndex;
      _veh addItemCargoGlobal [_type, _amount];
    } foreach _magazineCargo#0;

    {
      _type = _x;
      _amount = _weaponCargo#1#_forEachIndex;
      _veh addItemCargoGlobal [_type, _amount];
    } foreach _weaponCargo#0;
...

  {
    ...
    _wp = _group addWaypoint [[0,0,0], 0];
